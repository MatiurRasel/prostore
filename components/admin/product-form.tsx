...
const ProductForm = ({
    ...
    const handleGenerateDescription = async () => {
        ...
        const res = await generateProductDescription(`Write a description for a product named ${name}. Include key features and be persuasive.`);
        if (res.success && res.text) {
            ...
            toast({
                title: 'Error',
                description: res.error || 'Failed to generate',
                variant: 'destructive',
            });
        }
    };
